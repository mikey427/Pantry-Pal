...
export default function NewNavbar() {
	...
	const [currentTab, setCurrentTab] = useState(window.location.href.split("/")[3]);
	return (
				...
				>
					<div className="space-y-1 px-2 pb-3 pt-2">
						...
						<a
							href="/"
							className={`${
								currentTab === "" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700"
						...
						<a
							href="/meal_planner"
							className={`${
								currentTab === "meal_planner" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700"
							} hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
						>
							Meal Planner
						</a>
						<a
							href="/ingredients"
							className={`${
								currentTab === "ingredients" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700"
							} hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
						>
							Ingredients
						</a>
						<a
							href="/shopping_list"
							className={`${
								currentTab === "shopping_list" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700"
							} hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
						>
							Shopping List
						</a>
						<a
							href="/saved_meals"
							className={`${
								currentTab === "saved_meals" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700"
							} hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
						>
							Saved Meals
						</a>
