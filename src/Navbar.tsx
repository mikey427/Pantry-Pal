...
export default function Navbar({}: Props) {
  return (
    <div className='flex items-center top-0 h-12'>
        ...
        <Link className=' flex items-center m-auto bg bg-yellow-300 w-48 h-full rounded-2xl hover:bg-yellow-500 hover:shadow-lg' to="/" >
