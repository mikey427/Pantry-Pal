			...
			{viewMode === "grid" ? (
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
					{filteredMeals.map(meal => (
						<div key={meal.id + 1} className="bg-primaryLight shadow-md rounded-md p-4 text-white">
				...
				<div>
					{filteredMeals.map(meal => (
						<div key={meal.id + 1} className="bg-primaryLight text-white shadow-md rounded-md p-2 flex items-center justify-between mb-2">
							...
							<div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
								<form>
									...
									<div className="flex justify-end">
										...
										/>
										<Button callback={closeModal} styles="bg-red-500 text-white border-0" text="Cancel" />
									</div>
								</form>
							</div>
						</div>
