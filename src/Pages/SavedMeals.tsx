			...
			{viewMode === "grid" ? (
				...
				<div>
					{filteredMeals.map(meal => (
						<div
							key={meal.id + 1}
							className="bg-white shadow-md rounded-md p-2 flex items-center justify-between mb-2"
						>
			...
			{modalOpen && (
				<div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center">
					...
					<div className="relative w-1/4 h-1/2 bg-white p-8 rounded-md">
						...
						<form>
							<div className="flex flex-col mb-4">
								...
								<input
									...
									value={mealNameInput}
									onChange={event =>
										setMealNameInput(event.target.value)
									}
								/>
							</div>
							...
							<div className="flex flex-col mb-4">
								...
								<div className="flex mt-2">
									...
									<button
										type="button"
										className="text-sm h-8 bg-green-500 text-white rounded-md px-4"
										onClick={() => {
						...
						<svg
							className="absolute cursor-pointer top-2 right-2 w-8 h-8 bg-red-500 text-white fill-white rounded"
							onClick={closeModal}
